...
function shake(){
	for(var i=0; i<nObjetos; i++){
		...
		g.GetComponent.<Rigidbody>().AddForce (0, 700*Random.value, 0);
		g.GetComponent.<Rigidbody>().AddTorque (1000*Random.value, 1000*Random.value, 1000*Random.value);
	}	
}
...
function spawn(){
	for(var i=0; i<nObjetos; i++){
		...
		l.GetComponent.<Rigidbody>().AddTorque (1000*Random.value, 1000*Random.value, 1000*Random.value);
	}
}